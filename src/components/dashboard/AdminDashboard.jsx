// src/components/dashboard/AdminDashboard.jsx - Updated version
...
const AdminDashboard = () => {
    ...
    const fetchDashboardData = async () => {
      try {
        ...
        try {
          ...
          // Continue with empty users array but don't fail completely
        }
        ...
        try {
          ...
          // Continue with empty chains array but don't fail completely
        }
        
        // Calculate stats - with safeguards for empty data
        ...
        // Get recent supply chains (safely)
        if (chains.length > 0) {
  ...
  // Render a basic dashboard even when there's no data
          ...
          <div className="p-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
              {Object.keys(stats.usersByRole).length > 0 ? (
                ...
                <div className="col-span-5 text-center py-4 text-gray-500">No user role data available</div>
              )}
            </div>
          </div>
        </div>
          ...
          <div className="bg-white rounded-lg shadow">
            <div className="p-6">
              ...
              {recentSupplyChains.length > 0 ? (
                ...
                <div className="text-center py-8 text-gray-500">No supply chain data available</div>
              )}
            </div>
          </div>
        </div>
