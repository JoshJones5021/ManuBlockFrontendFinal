// src/components/supplier/MaterialAllocation.jsx
...
const MaterialAllocation = () => {
    ...
    const fetchAllocatedMaterials = async () => {
        try {
            ...
            // In a real implementation, this would be an actual API call to
            ...
            // Transform for UI representation - this would be formatted properly by the backend
            const allocated = [];
    ...
    const handleViewBlockchain = async (material) => {
        ...
        try {
            // Fetch blockchain details for the item
                            ...
                            <tbody className="bg-white divide-y divide-gray-200">
                                {allocatedMaterials.map((material) => (
                                    <tr key={material.id}>
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <div className="text-sm text-gray-900">{material.requestNumber}</div>
                                        </td>
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <div className="text-sm text-gray-900">{material.manufacturer}</div>
                                        </td>
                                        <td className="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <span className="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">
                                                Tracked - ID: {material.blockchainItemId.toString().substring(0, 8)}...
                                            </span>
                                        </td>
                            ...
                            <div>
                                <div className="bg-gray-100 p-4 rounded-lg mb-4">
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <p className="text-sm font-medium">{blockchainDetails.id}</p>
                                        </div>
                                        <div>
                                            <p className="text-sm text-gray-500 mb-1">Item Type</p>
                                            <p className="text-sm font-medium">{blockchainDetails.itemType}</p>
                                        </div>
                                        <div>
                                            <p className="text-sm text-gray-500 mb-1">Owner</p>
                                            <p className="text-sm font-mono break-all">{blockchainDetails.owner}</p>
                                        </div>
                                        <div>
                                            <p className="text-sm text-gray-500 mb-1">Quantity</p>
                                            <p className="text-sm font-medium">{blockchainDetails.quantity}</p>
                                        </div>
                                        <div>
                                            <p className="text-sm text-gray-500 mb-1">Supply Chain ID</p>
                                            <p className="text-sm font-medium">{blockchainDetails.supplyChainId}</p>
                                        </div>
                                        <div>
                                            <p className="text-sm text-gray-500 mb-1">Status</p>
                                            <p className="text-sm font-medium">
                                                {blockchainDetails.status === 0 ? "Created" :
                                                    blockchainDetails.status === 1 ? "In Transit" :
                                                        blockchainDetails.status === 2 ? "Processing" :
                                                            blockchainDetails.status === 3 ? "Completed" :
                                                                blockchainDetails.status === 4 ? "Rejected" : "Unknown"}
                                            </p>
                                        </div>
                                        <div>
                                            <p className="text-sm text-gray-500 mb-1">Active</p>
                                            <p className="text-sm font-medium">{blockchainDetails.isActive ? "Yes" : "No"}</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="mb-4">
                                    ...
                                    <p className="text-sm text-gray-600">
                                        This material item has been allocated to {selectedMaterial.manufacturer} and
                                        is available for pickup and delivery. Once delivered, the manufacturer will be able
                                ...
                                <div className="flex justify-center mb-4">
                                    <div className="relative py-3">
                                        ...
                                        <div className="relative flex justify-between">
                                            ...
                                            <div className="flex flex-col items-center">
                                                <div className="rounded-full h-8 w-8 bg-gray-200 text-gray-500 flex items-center justify-center">-</div>
