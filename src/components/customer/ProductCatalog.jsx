    ...
    if (selectedChain !== 'all') {
      filtered = filtered.filter(product => {
        if (!product.supplyChainId) {
          const chain = supplyChains.find(
            c => c.id === parseInt(selectedChain)
          );
          if (chain) {
            return (
              product.name.toLowerCase().includes(chain.name.toLowerCase()) ||
        ...
        <div className="bg-white rounded-lg shadow-md p-6 text-center">
          ...
          >
            <path
              ...
              strokeLinejoin="round"
              strokeWidth="2"
              d="M9.172 16.172a4 4 0 015.656 0M9 10h.01M15 10h.01M12 12.01a4 4 0 110-8 4 4 0 010 8z"
            />
          </svg>
                  ...
                  {product.supplyChainId && (
                    <div className="mb-4 text-sm">
                      ...
                      <span className="text-gray-900">
                        {getSupplyChainName(product.supplyChainId)}
                      </span>
                    </div>
                  )}
