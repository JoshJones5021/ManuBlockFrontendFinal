        ...
        <div className="bg-white rounded-lg p-8 max-w-2xl w-full max-h-screen overflow-y-auto">
          ...
          {selectedOrder.deliveryNotes && (
            <div className="mb-4">
              ...
              <p className="whitespace-pre-line">{selectedOrder.deliveryNotes}</p>
            </div>
          )}
          ...
          <div className="mt-4 flex justify-between items-center">
            <div>
              ...
              <p className="text-xl font-bold">${calculateOrderTotal(selectedOrder).toFixed(2)}</p>
            </div>
            ...
            <div className="space-x-2">
              ...
              {['Requested', 'In Production'].includes(selectedOrder.status) && (
                <button
