...
const OrderDetails = () => {
  ...
  useEffect(() => {
    const fetchDistributors = async () => {
      try {
        const response = await supplyChainService.getAssignedUsers(
          order.supplyChainId
        );

        if (response?.data && Array.isArray(response.data)) {
          const chainDistributors = response.data.filter(
  ...
  const handleFulfillOrder = async e => {
    ...
    try {
      ...
      const response = await manufacturerService.fulfillOrderFromStock(
        order.id,
        fulfillmentData
      );
        ...
        <div className="p-6">
              ...
              {canFulfillFromInventory() ? (
                <div className="bg-green-50 p-4 rounded-lg">
                  <h3 className="text-lg font-medium text-green-800 mb-2">
                    Good news! All items in stock.
                  </h3>
                  <p className="text-green-700 mb-4">
                    You have sufficient inventory to fulfill this order
                    immediately.
                  </p>
                  <button
                ...
                <div className="bg-yellow-50 p-4 rounded-lg">
                  ...
                  <p className="text-yellow-700 mb-4">
                    You don't have enough stock to fulfill this order. You'll
                    need to manufacture more products.
                  </p>
                  <button
                    onClick={() =>
          ...
          {order.status === 'In Production' && (
            <div className="bg-yellow-50 p-4 rounded-lg">
              ...
              <p className="text-yellow-700 mb-4">
                You need to complete all production batches for this order
          ...
          {order.status === 'Ready for Shipment' && (
            <div className="bg-green-50 p-4 rounded-lg">
              ...
              <p className="text-green-700">
                The products have been reserved from inventory and the
          ...
          {(order.status === 'In Transit' ||
            ...
            <div className="bg-blue-50 p-4 rounded-lg">
              ...
              <p className="text-blue-700">
                {order.status === 'In Transit'
                  ? 'The distributor is delivering this order to the customer.'
                  : order.status === 'Delivered'
