  ...
  const handleSchedule = async () => {
    ...
    try {
      ...
      const transportData = {
        ...
        scheduledPickupDate: pickupDate.getTime(),
        scheduledDeliveryDate: deliveryDate.getTime(), 
      ...
      if (onComplete) {
        onComplete(
          `Material pickup scheduled successfully for ${materialRequest.requestNumber}`
        );
      }
    } catch (err) {
        ...
        <div className="mb-4 bg-gray-50 p-4 rounded-md border border-gray-200">
          ...
          <div className="mb-2">
            ...
            <span className="break-words">
              {materialRequest.manufacturer?.username || 'Unknown'}
            </span>
          </div>
          <div className="mb-2">
            <span className="font-medium text-gray-700 mr-1">
